...
describe("generic utility functions", function () {
  it("should jitter an integer", function () {
    ...
    assert.closeTo(
      ...
      100,
      10,
      "jittering 100 by 10 is close to 100"
    );
  ...
  it("should flip a coin", function () {
    ...
    assert.closeTo(
      ...
      50,
      45,
      "of 100 flips should be some trues and some falses"
    );
  });
  ...
  it("should deep copy an opject", function () {
    ...
    assert.deepEqual(
      util.deepCopy(obj),
      obj,
      "deep copied object should be equal"
    );
    assert.notEqual(
      util.deepCopy(obj),
      obj,
      "deep copied objects not the same"
    );
  });
